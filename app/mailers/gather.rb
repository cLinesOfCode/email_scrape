class Gather < ApplicationMailer
	...
	# 	html = '<img src="http://www.imageurlhost.com/images/mdlbd562jdypkwv1jcs5.png" style="height:50px;"></img>
	# <br><br>
	# We at Associated Students for Change (ASoC) want to share with you a project we are supporting in an effort to bring people back together. Below is a snippet from our post.. 
	# <br><br>
	...
	# <br><br>
	# <img src="http://www.imageurlhost.com/images/mdlbd562jdypkwv1jcs5.png" style="height:25px;width:25px"></img>
	# <br><br>
	# With Love, 
	# <br><br>
	# ASoC
